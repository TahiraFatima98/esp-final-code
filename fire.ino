...
#define FIREBASE_HOST "https://pose-detection-8bab0.firebaseio.com"                     //Your Firebase Project URL goes here without "http:" , "\" and "/"
#define FIREBASE_AUTH "RyP6lsk33Djdrd0K54jnrRULToMcjOH0qwv7I3TP" //Your Firebase Database Secret goes here

#define WIFI_SSID "ZONG4G-5B53"                                               //WiFi SSID to which you want NodeMCU to connect
#define WIFI_PASSWORD "01083559"                                      //Password of your wifi network 
...
void setup() {
  ...
  Serial.println(WiFi.localIP());                                            //print local IP addre
...
void loop() {
  server.handleClient();
  if (Firebase.getInt(firebaseData, "/Id", val)) {
